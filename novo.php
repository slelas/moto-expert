    ...
    <body>
        ...
        <div class="motor-list__filters-collapsible">
            ...
            <div class="motor-list__filters">
                ...
                <a href="<cms:link 'novo.php' />" class="motor-list__filter motor-list__filter--state-active">
                    <div class="motor-list__filter-imgs">
                        <img class="motor-list__filter-img" src="/images/novi-motocikli-1-bijelo.svg">
                    </div>
                    <span class="motor-list__filter-title" style="color: white;">NOVI MOTOCIKLI</span>
        ...
        <section class="motor-list">
            ...
            <cms:pages masterpage='motor.php' folder='novo'>
